...
// TestProvenanceCitesOnlyTheIC7700Authority is the POSITIVE-LIST provenance
...
// citation core/driver/ic7700 and core/civ/ic7700 make — PDF pages, printed
...
// at a time, against the IC-7700 authority; where that authority is present the
...
func TestProvenanceCitesOnlyTheIC7700Authority(t *testing.T) {
	drivertest.IcomCitationPin("ic7700").Assert(t)
}
