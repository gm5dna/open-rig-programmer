...
func TestDriverImplementsSerialFramingReporter(t *testing.T) {
	...
	if !ok {
		t.Fatal("the IC-7610 driver does not implement driver.SerialFramingReporter - spec D3.1 requires every Icom driver to report its framing")
	}
...
//
// The IC-7610's CI-V Reference Guide says NOTHING about serial framing —
