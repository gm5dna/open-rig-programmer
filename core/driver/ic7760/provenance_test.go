...
// in particular. It extracts EVERY document citation core/driver/ic7760 and
// core/civ/ic7760 make — PDF pages, printed folios, matrix sections and
// errata, and assumption-register ids — and requires each to be one
