...
// TestProvenanceCitesOnlyTheIC7100Authority is the POSITIVE-LIST provenance
...
// in particular. It extracts EVERY document citation core/driver/ic7100 and
// core/civ/ic7100 make — PDF pages, printed folios, matrix sections and errata,
...
// at a time, against the IC-7100 authority; where that authority is present the
...
func TestProvenanceCitesOnlyTheIC7100Authority(t *testing.T) {
	drivertest.IcomCitationPin("ic7100").Assert(t)
}
