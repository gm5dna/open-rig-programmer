...
// explicitly in this driver's bank maps (caps.go's memFields/pmsFields),
// including the twenty-one that carry the zero FieldSupport — so none of
// THOSE needs a second reason here.
