...
// sentence for an empty GotModel, and TestOpen_WrongRadio pins both shapes.
//
...
// spelling. core/driver/ts590's siblingModelName is the corrected twin this
// arm follows.
func siblingModelName(id string) string {
	...
	case "022":
		...
		// second milestone; printed BARE, named by this registry's own key.
		return "TS-990S"
	case "024":
