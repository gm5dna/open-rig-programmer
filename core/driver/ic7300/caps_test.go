...
var deliberatelyUnexpressedFields = map[spec.Field]string{
	...
	spec.FieldAttenuator:        "additions design D8 — the IC-7300 memory frame carries no attenuator field",
	spec.FieldPreamp:            "additions design D8 — the IC-7300 memory frame carries no preamp field",
	spec.FieldAntenna:           "additions design D8 — the IC-7300 memory frame carries no antenna-selection field",
	spec.FieldIPPlus:            "additions design D8 — the IC-7300 memory frame carries no IP+ field",
}
