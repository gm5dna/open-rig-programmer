...
//
// This file holds the empty declaration of exItems590SG so that package
// ts590 COMPILES between task 5, which created it, and lane P's task 9b,
// which transcribes the TS-590SG EX parameter list (from 590:744) into
// menu590sg.csv and generates this file from it.
//
...
// inventory's length equals the ts590sg profile's ExpectedRows, and task 10
