...
func tagDisplayRadioConfig() cat.DialectConfig {
	return cat.DialectConfig{
		...
		EXItems: []cat.EXItem{
			{Addr: cat.EXAddress{P1: 8, P2: 1, P3: 3}, P1Label: "RADIO", P2Label: "GROUP", Name: "ITEM", Digits: 4},
		},
		MT: cat.MTPolicy{
...
// of all four Stage 0 axes at once: MCSelectsMemoryPMS, MTReadsMemoryPMS,
// P5Fixed and P11TagDisplay together are the FT-891's declared shape, and if
// any of them became unreachable from outside core/cat this stops compiling
// here rather than at Stage 1's first task.
