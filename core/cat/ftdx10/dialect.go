...
var dialect = cat.MustNewDialect(cat.DialectConfig{
	...
	// radio's MR-answer/MW-set frame is the registered 28-byte, 9-digit-P2
	// shape, and its P9 is printed-fixed "00" on every memory-bearing
	// block. Not an assumption: this is the legend, transcribed.
	MemoryFrameLen:   28,
	MemoryFreqDigits: 9,
