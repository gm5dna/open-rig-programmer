...
// This file is fakeft450d's imports_test.go, COPIED — copied because the
...
// which fakeft900 must never have, in this directory or any beneath it
...
func TestIsForbiddenImport(t *testing.T) {
	tests := []struct {
		...
		{"core/bincat — the frame grammar this package was allowed to READ but not import", "github.com/gm5dna/open-rig-programmer/core/bincat", true},
		...
		{"core/driver/ft890900 — the (not-yet-existing) driver under test against this fake", "github.com/gm5dna/open-rig-programmer/core/driver/ft890900", true},
		{"internal/fakeft890 — the sibling fake this package pairs with in the milestone, deliberately not shared", "github.com/gm5dna/open-rig-programmer/internal/fakeft890", true},
		{"internal/fakeradio — the FT-710's", "github.com/gm5dna/open-rig-programmer/internal/fakeradio", true},
		{"fakeft900 itself", "github.com/gm5dna/open-rig-programmer/internal/fakeft900", true},
...
// TestNoCoreImports enforces THE HARD RULE (see doc.go): fakeft900 must
// not import anything project-internal — not core/bincat, not
// core/codeplug, not core/spec, not core/driver/ft890900, and not any
...
func TestNoCoreImports(t *testing.T) {
	...
	for _, v := range res.violations {
		t.Errorf("%s imports %q — fakeft900 MUST NOT import any project-internal package, in this directory or any beneath it (see doc.go, THE HARD RULE)", v.file, v.path)
	}
