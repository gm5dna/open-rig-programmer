...
// This family's constants (ft900-capability-matrix.md §1.9, §1.10, §2):
// 100 channels numbered 1..100, a 19-byte per-channel record (identical
// shape to the FT-890's own), and a 1941-byte full-dump — the one genuine
// wire-length difference between the two radios (matrix §1.10).
const (
	slotBase    = 1
	slotCount   = 100
	recordLen   = 19
