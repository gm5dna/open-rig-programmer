...
// which exists for readability only: entries are cited BY NAME, never by
// position.
...
// readPackageSources returns the normalised text of every non-test .go file
// in this directory, keyed by file name.
