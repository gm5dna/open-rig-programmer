...
// Radio is a simulated FT-450D: an in-memory duplex pipe presenting the
...
type Radio struct {
	...
	ai             byte // '0' or '1'; OFF at construction
}
...
func New(opts ...Option) *Radio {
	r := &Radio{
		...
		// OFF at construction: New models a freshly-powered radio, the
		// same default every registered Yaesu fake in this fleet takes.
		ai: '0',
	}
