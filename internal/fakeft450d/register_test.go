...
var registerEntries = []string{
	...
	`THE "NO SELECTION YET" CHANNEL IS "000"`,
	"TONE INDEX (P9) IS STORED AT ITS PRINTED WIDTH",
	"SET-DIRECTION FIELD STRICTNESS",
	"AN ANSWER'S KIND BYTE IS ALWAYS '1'",
	"PMS SLOTS (501-504) REFUSE EVERY MW SET",
	"A SET DOES NOT MOVE THE SELECTED CHANNEL",
	"AN MW SET CREATES AN ABSENT MEMORY CHANNEL",
	"THE FRAME ACCUMULATOR'S CAP AND RESYNC",
	"THE DEFAULT IMAGE'S CONTENT IS INVENTED",
	"AI-SET IS FIRE-AND-FORGET",
}
