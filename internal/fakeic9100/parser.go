...
// code; the package's own tests exercise the resulting independent byte
// grammar. The frame shape — FE FE <to> <from> <data> FD, OK 0xFB, NG
// 0xFA — is the tier-wide Icom CI-V constant (doc.go).
