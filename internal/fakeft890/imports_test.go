...
// which fakeft890 must never have, in this directory or any beneath it
...
func TestIsForbiddenImport(t *testing.T) {
	tests := []struct {
		...
		{"internal/fakeft900 — the sibling fake this package pairs with in the milestone, deliberately not shared", "github.com/gm5dna/open-rig-programmer/internal/fakeft900", true},
		{"internal/fakeradio — the FT-710's", "github.com/gm5dna/open-rig-programmer/internal/fakeradio", true},
		{"fakeft890 itself", "github.com/gm5dna/open-rig-programmer/internal/fakeft890", true},
...
// TestNoCoreImports enforces THE HARD RULE (see doc.go): fakeft890 must
...
func TestNoCoreImports(t *testing.T) {
	...
	for _, v := range res.violations {
		t.Errorf("%s imports %q — fakeft890 MUST NOT import any project-internal package, in this directory or any beneath it (see doc.go, THE HARD RULE)", v.file, v.path)
	}
