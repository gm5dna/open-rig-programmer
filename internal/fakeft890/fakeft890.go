...
// Radio is a simulated FT-890: an in-memory duplex pipe presenting the
...
// New constructs a *Radio, seeds its 32 channels with a fixed non-zero
...
// buildFullDump renders the full 649-byte RAM table (matrix §1.10): 3
...
// operating record, VFO-A (9) and VFO-B (9), then 32 19-byte channel
// records in order.
