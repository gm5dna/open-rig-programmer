...
// transmit frequency yourself" cost here, and no FM-only refusal. What
// REPLACES them is the create-path cost: one frame carries a whole channel,
// so a blank target is refused rather than created, and the entry says so in
// the sentence Q10 requires.
//
