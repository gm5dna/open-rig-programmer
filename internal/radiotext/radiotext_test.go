...
// TestRadiotext_TS590Pair_GridLegendCarriesItsTwoPublishedCosts pins, on
// each 590 row, the two write refusals a user meets in ordinary use and
// which the verbatim pins above would also catch — but only by accident,
// because a reworded legend that quietly dropped one of the two would still
// be "verbatim" once somebody updated the literal. This is the FT-891's
...
func TestRadiotext_TS590Pair_GridLegendCarriesItsTwoPublishedCosts(t *testing.T) {
