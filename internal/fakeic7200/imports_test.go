...
// which fakeic7200 must never have, in this directory or any beneath it
...
func TestIsForbiddenImport(t *testing.T) {
	tests := []struct {
		...
		{"core/civ/ic7200 — the dialect this fake is the other witness to", "github.com/gm5dna/open-rig-programmer/core/civ/ic7200", true},
		{"core/driver — the layer under test against this fake", "github.com/gm5dna/open-rig-programmer/core/driver", true},
		{"core/driver/ic7200", "github.com/gm5dna/open-rig-programmer/core/driver/ic7200", true},
		...
		{"fakeic7200 itself", "github.com/gm5dna/open-rig-programmer/internal/fakeic7200", true},
		...
		{"clone dir name is not the module path either", "codex-icom-ic7200/core/civ", false},
...
// TestNoCoreImports enforces THE HARD RULE (see doc.go): fakeic7200 must
// not import anything project-internal — not core/civ, not
// core/civ/ic7200, not core/driver, not core/codeplug, not core/spec and
// not any sibling fake — so that a systematic misreading of the IC-7200
...
func TestNoCoreImports(t *testing.T) {
	...
	for _, v := range res.violations {
		t.Errorf("%s imports %q — fakeic7200 MUST NOT import any project-internal package, in this directory or any beneath it (see doc.go, THE HARD RULE)", v.file, v.path)
	}
...
func fenceTestTree(t *testing.T) string {
	...
	return writeTree(t, map[string]string{
		"clean.go":           "package p\n\nimport \"io\"\n\nvar _ io.Reader\n",
		"gen/main.go":        "package main\n\nimport _ \"github.com/gm5dna/open-rig-programmer/core/civ/ic7200\"\n",
...
func TestScanForbiddenImports_CatchesAForbiddenImportInASubdirectory(t *testing.T) {
	...
	if want := "github.com/gm5dna/open-rig-programmer/core/civ/ic7200"; got.path != want {
