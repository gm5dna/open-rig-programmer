...
// Radio is a simulated TS-990S: an in-memory duplex pipe presenting the host
...
// TS-890S is a separate package because the two books print different grids.
type Radio struct {
	...
	// with a meaning (990:173-178). It starts OFF, which is this package's
...
// models a sentence of this book's own error table (990:101-121) rather than a
// misbehaving radio:
//
