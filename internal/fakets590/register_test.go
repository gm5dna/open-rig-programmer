...
var registerEntries = []string{
	...
	"AN ANSWER'S HUNDREDS DIGIT IS A SPACE BELOW CHANNEL 100",
	"THE SECOND HALF OF A CHANNEL WITH NO STORED TRANSMIT RECORD",
	`A SET CARRYING A "NONE" MODE NIBBLE IS STORED`,
	"TONE INDICES ARE STORED, NOT RANGE-CHECKED",
	"BYTE 28 IS ACCEPTED EITHER WAY ON BOTH ROWS",
	"A SET DOES NOT MOVE THE SELECTED CHANNEL",
	"THE SELECTED CHANNEL AT CONSTRUCTION",
	"THE SG'S EXTENSION CHANNELS ARE NOT SERVED",
