...
func TestIsForbiddenImport(t *testing.T) {
	tests := []struct {
		...
		{"core/civ/ic7800 — the codec this fake must not consult", "github.com/gm5dna/open-rig-programmer/core/civ/ic7800", true},
		{"core/driver — the layer under test against this fake", "github.com/gm5dna/open-rig-programmer/core/driver", true},
		{"core/driver/ic7800 — the driver under test against this fake", "github.com/gm5dna/open-rig-programmer/core/driver/ic7800", true},
		...
		{"fakeic7800 itself", "github.com/gm5dna/open-rig-programmer/internal/fakeic7800", true},
...
// TestNoCoreImports enforces THE QUARANTINE (see doc.go): fakeic7800 must
// not import anything project-internal — not core/civ, not
// core/civ/ic7800, not core/driver/ic7800, not any sibling fake — so that a
// systematic misreading of the IC-7800 memory record cannot agree with
...
func TestNoCoreImports(t *testing.T) {
	...
	for _, v := range res.violations {
		t.Errorf("%s imports %q — fakeic7800 MUST NOT import any project-internal package, in this directory or any beneath it (see doc.go, THE QUARANTINE)", v.file, v.path)
	}
...
func fenceTestTree(t *testing.T) string {
	...
	return writeTree(t, map[string]string{
		"clean.go":           "package p\n\nimport \"io\"\n\nvar _ io.Reader\n",
		"gen/main.go":        "package main\n\nimport _ \"github.com/gm5dna/open-rig-programmer/core/civ/ic7800\"\n",
...
func TestScanForbiddenImports_CatchesAForbiddenImportInASubdirectory(t *testing.T) {
	...
	if want := "github.com/gm5dna/open-rig-programmer/core/civ/ic7800"; got.path != want {
