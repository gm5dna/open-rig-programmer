...
// fakets890 must never have, in this directory or any beneath it (see doc.go,
...
func TestIsForbiddenImport(t *testing.T) {
	tests := []struct {
		...
		{"core/driver/ts890 — the driver under test against this fake", "github.com/gm5dna/open-rig-programmer/core/driver/ts890", true},
		...
		{"internal/fakets990 — this milestone's other new fake, whose grid and legends differ", "github.com/gm5dna/open-rig-programmer/internal/fakets990", true},
		...
		{"fakets890 itself", "github.com/gm5dna/open-rig-programmer/internal/fakets890", true},
...
// TestNoCoreImports enforces THE HARD RULE (see doc.go): fakets890 must not
...
func TestNoCoreImports(t *testing.T) {
	...
	for _, v := range res.violations {
		t.Errorf("%s imports %q — fakets890 MUST NOT import any project-internal package, in this directory or any beneath it (see doc.go, THE HARD RULE)", v.file, v.path)
	}
