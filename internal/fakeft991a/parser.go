...
//
// strings.TrimRight would do, and this package could import strings — the hard
// rule forbids project-internal imports, not the standard library. It is four
// lines here so that the tag's trimming rule is visible beside the storage
// decision it implements rather than behind a call whose second argument is a
// cutset rather than a byte.
