...
// Radio is a simulated IC-7600: an in-memory duplex pipe presenting the host
...
// New constructs a simulated IC-7600 and starts its servicing goroutines.
//
// No channel is set. This fake seeds NO factory image and invents NO record
// contents: matrix §0 records that no IC-7600 has ever been asked anything,
...
// dispatch handles one complete frame: the address filter, then the answer.
//
// Unlike internal/fakeic7800 and internal/fakeic7851, this package has no
// echo step here at all — see doc.go, "No echo option".
