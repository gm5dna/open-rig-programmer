...
Section
    ...
    # installer by the same arch-selected shape the wails.files macro
    # uses above (wails_tools.nsh — a line-range citation would be
    # fragile since this file is regenerated by every -nsis build) —
    # one makensis process builds both arch
