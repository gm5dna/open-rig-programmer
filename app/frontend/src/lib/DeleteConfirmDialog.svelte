...
<ConfirmDialog
	...
	title="Clear {slotDisplay} in this file?"
	body={`The radio keeps the channel until you delete it from the front panel — sending marks it "erased (unsupported)".`}
	note={eraseNote}
	confirmLabel="Clear {slotDisplay}"
	{onconfirm}
	{oncancel}
/>
