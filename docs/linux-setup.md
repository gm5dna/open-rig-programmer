...
toolchain, with only an SSH server added before the observations
below were taken (lintian was installed on the arm64 VM afterwards,
for an informational run) — and exercised there:
